...
export default function Home() {
  ...
  const fullText = "Join our affiliate network and start earning commissions on every sale you refer. Its easy, fast, and  profitable.";
  ...
  return (
    <>
          ...
          <div className="container px-4 md:px-6 space-y-10 xl:space-y-16">
            <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
              ...
              <div className="hidden md:block">
                <video autoPlay loop muted className="right-0 mb-4 ml-32 rounded-xl object-cover  " style={{ width: '450px', height: '450px' }}>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Our curated selection of products offer high commissions and convert at industry-leading rates. Start
                  earning today.
                </p>
              </div>
            </div>
            <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
              <div className="grid gap-1">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-bold text-[#1F2937]">High-Ticket Gadgets</h3>
                </div>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Promote our cutting-edge tech products and earn up to 20% commissions.
                </p>
                <Link className="text-[#6366F1] font-medium hover:underline" href="#">
                  View Products
                </Link>
              </div>
              <div className="grid gap-1">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-bold text-[#1F2937]">Subscription Services</h3>
                </div>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Earn recurring commissions by promoting our popular subscription services.
                </p>
                <Link className="text-[#EC4899] font-medium hover:underline" href="#">
                  View Products
                </Link>
              </div>
              <div className="grid gap-1">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-bold text-[#1F2937]">Lifestyle Products</h3>
                </div>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Promote our high-quality lifestyle products and earn generous commissions.
                </p>
                <Link className="text-[#6366F1] font-medium hover:underline" href="#">
                  View Products
                </Link>
          ...
          <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-gray-200 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                TRONQ AGENCIES is a Legitimate Certified Agency offering you a revolutionized ways of earning at the comfort of your home using your smartphone or laptop HOW DO YOU GET STARTED?
              </p>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-8">
              <div className="space-y-4">
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Chat with Our Team</h2>
                <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Have questions about our affiliate program? Chat with our team to get the answers you need.
                </p>
              </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 Tronq. All rights reserved.</p>
